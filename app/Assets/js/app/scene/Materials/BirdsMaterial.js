...
import BirdsFragmentShader from '@shaders/birds.frag';

export default class BirdsMaterial extends CustomMaterial {
    constructor(scene, name) {
        super(scene, name);

        this.loadShaderData(name, BasicVertexShader, BirdsFragmentShader);
